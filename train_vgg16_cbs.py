...
manager  = tf.train.CheckpointManager(ckpt, directory='checkpoint/vgg16cbs_checkpoint', max_to_keep=20)
emanager = tf.train.CheckpointManager(ckpt, directory='checkpoint/vgg16cbs_echeckpoint', max_to_keep=20)
...
for epoch in range(START, EPOCHS):
	...
	with open('vgg16cbs_log.txt', 'a') as file:
