...
manager  = tf.train.CheckpointManager(ckpt, directory='checkpoint/resnet18_checkpoint', max_to_keep=20)
emanager = tf.train.CheckpointManager(ckpt, directory='checkpoint/resnet18_echeckpoint', max_to_keep=20)
...
for epoch in range(START, EPOCHS):
	...
	with open('resnet18_log.txt', 'a') as file:
